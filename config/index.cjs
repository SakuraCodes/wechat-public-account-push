...
const USER_CONFIG = {
  ...
  TIAN_API: {
    ...
    key: '9ed5ab8316665068338e2283cd9d7458',
  ...
  USERS: [
    {
      ...
      // id: 'ovlZ06unaaml04SvY8SwcJ4N2OfQ',
      id: 'ovlZ06qnEtuKf5vCKfrAoDFrC-1A',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      // 使用其他通道时，请填写 config/template-config.cjs 中某个想要使用的模板的id
      useTemplateId: 'C1Pr7oOdgdNIXngFeKJYQtc4kJy_gJiyoW7tnJkjo-M',
      // 所在省份或城市，也可以不填
      province: '浙江',
      // 所在城市或县区
      city: '杭州',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '宝宝', year: '2004', date: '08-26', isShowAge: true,
        },
        {
          type: '节日', name: '恋爱❤纪念日', year: '2023', date: '03-27',
          // 实际时间: '03-26'
        }
      ],
  ...
  CALLBACK_TEMPLATE_ID: 'iWbiaLXuc-4qL0-AoQLpZgA6oEvJaI7m2HZ2YHY4shk',
